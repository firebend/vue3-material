  ...
  >
    ...
    <div class="page-container-section">
      ...
      >
        ...
        primary: palette.md-get-palette-color(blue, A200), // The primary color of your application
        accent: palette.md-get-palette-color(red, A200) // The accent or secondary color
        ));
    ...
    <div class="page-container-section">
      ...
      >
        ...
        @include md-register-theme("default", (
        primary: palette.md-get-palette-color(green, A200), // The primary color of your application
        accent: palette.md-get-palette-color(pink, 500) // The accent or secondary color
        ));
