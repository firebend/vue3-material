...
<style lang="scss" scoped>
  ...
  @include md-register-theme("green-card", (
    primary: palette.md-get-palette-color(green, 500)
  ));

  @include md-register-theme("black-card", (
    primary: palette.md-get-palette-color(black, 500)
  ));

  @include md-register-theme("purple-card", (
    primary: palette.md-get-palette-color(purple, 500)
  ));

  @include md-register-theme("orange-card", (
    primary: palette.md-get-palette-color(orange, 500)
  ));
