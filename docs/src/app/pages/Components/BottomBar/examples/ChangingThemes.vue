...
<style lang="scss">
  ...
  @include md-register-theme("bottom-bar-teal", (
    primary: palette.md-get-palette-color(teal, A200)
  ));

  @include md-register-theme("bottom-bar-orange", (
    primary: palette.md-get-palette-color(orange, A200)
  ));

  @include md-register-theme("bottom-bar-blue", (
    primary: palette.md-get-palette-color(blue, A200),
    accent: palette.md-get-palette-color(red, A200)
  ));

  @include md-register-theme("bottom-bar-red", (
    primary: palette.md-get-palette-color(red, A200)
  ));
